<%@page import="org.vo.Achievement"%>
...
<html>
  <head>
    ...
    <title>My JSP 'AchievementResult.jsp' starting page</title>
  ...
  <div>
     ...
     <div id="div3">  
    <h1 align="center"> 欢迎浏览晓薇在线课堂最新研究成果</h1>  
    <%
    	Achievement achievement = (Achievement)session.getAttribute("oneachievement");
